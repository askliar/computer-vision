function net = update_model(freeze, varargin)
...
net.meta.trainOpts.batchSize = 50 %varargin{1}.batchSize ;
net.meta.trainOpts.numEpochs = 50 %varargin{2}.numEpochs ;
[net.meta.trainOpts, varargin] = vl_argparse(net.meta.trainOpts, varargin{1}) ;
e = net.meta.trainOpts.numEpochs
%net.meta.trainOpts.numEpochs = numel(net.meta.trainOpts.learningRate) ;

net.meta.trainOpts.learningRate = [ 0.05*ones(1,round(double(e / 100) * 40)) ...
                                    0.005*ones(1,round((e / 100) * 40))...
                                    0.0005*ones(1,round((e / 100) * 20))...
                                    ] ;
