function [acc, pretrained, finetuned] = train_svm(nets, data)
...
fprintf('CNN: fine_tuned_accuracy: %0.4f, SVM: pre_trained_accuracy: %0.4f, fine_tuned_accuracy: %0.4f\n', nn.accuracy, svm.pre_trained.accuracy(1), svm.fine_tuned.accuracy(1));

acc = nn.accuracy;
pretrained = svm.pre_trained.accuracy(1);
finetuned = svm.fine_tuned.accuracy(1);
