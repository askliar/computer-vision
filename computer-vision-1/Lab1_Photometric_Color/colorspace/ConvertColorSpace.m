function [new_image] = ConvertColorSpace(input_image, colorspace, greyscale_method)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
elseif strcmp(colorspace, 'gray')
    new_image = rgb2grays(input_image, greyscale_method); % fill in this function
else
...
if nargin == 2
    ...
    visualize(new_image, sprintf('%s_%s', colorspace, greyscale_method));
end
